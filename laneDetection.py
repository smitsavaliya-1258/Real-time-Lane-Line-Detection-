...
def perspectiveWarp(inpImage):
    ...
    cv2.circle(inpImage, (200, 0), 5, (255, 0, 255), 5)
    cv2.circle(inpImage, (1200, 0), 5, (0, 0, 0), 5)
    cv2.circle(inpImage, (200, 710), 5, (255, 0, 0), 5)
    cv2.circle(inpImage, (1000, 640), 5, (255, 255, 255), 5)
...
def general_search(binary_warped, left_fit, right_fit):
    ...
    plt.xlim(0, 1280)
    plt.ylim(720, 0)
    ret = {'leftx': leftx, 'rightx': rightx, 'left_fitx': left_fitx, 'right_fitx': right_fitx, 'ploty': ploty}
...
def measure_lane_curvature(ploty, leftx, rightx):
    ...
    if leftx[0] - leftx[-1] > 200:
        curve_direction = 'Left Curve'
    elif leftx[-1] - leftx[0] > 200:
